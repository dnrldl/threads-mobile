import { Heart, Home, PenSquare, Search, User, type LucideIcon } from 'lucide-react';
...
function MainBottomNav() {
  ...
  const routeButtonClass = (isActive: boolean) =>
    cn(
      ...
      isActive ? 'bg-white/[0.08] text-white' : 'text-neutral-500 hover:text-white'
    );
  ...
  return (
    <>
      ...
      <ThreadComposerModal isOpen={isComposerOpen} onClose={() => setIsComposerOpen(false)} />
    </>
  );
}
